class RubysFantasticFourA
  ...
  def self.display_methods_a
    ...
    CliStart.alex_say("You are on the Ruby's Fantastic Four page. This page contains a table explaining four Ruby methods, or the Fantastic Four.")
  end
  ...
  def self.go_a(user)
    ...
    sleep 1
    self.computer_love_art_a
    puts "\n🔹 Here's the most important thing we learned: 🔹 \n\nYou have to nail Ruby's Fantastic Four methods."
    sleep 1
    RubysFantasticFour.display_methods_a
    CliStart.sam_say("The most important thing we learnt at the bootcamp is that you need to nail these four methods. How to choose the right method? Here's a lit of questions, which will help you decide.")
    ...
    CliStart.sam_say("Row second. Method: each. Description. Use when nothing else works or when you're feeling lazy.")
    RubysFantasticFour.after_table_a(user)
  end
